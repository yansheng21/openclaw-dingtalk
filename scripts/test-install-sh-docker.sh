...
CLI_INSTALL_URL="${OPENCLAW_INSTALL_CLI_URL:-${CLAWDBOT_INSTALL_CLI_URL:-https://raw.githubusercontent.com/yansheng21/openclaw-dingtalk/main/scripts/install-cli.sh}}"
INSTALL_PACKAGE="${OPENCLAW_INSTALL_PACKAGE:-${CLAWDBOT_INSTALL_PACKAGE:-openclaw-dingtalk}}"
INSTALL_CLI_BIN="${OPENCLAW_INSTALL_CLI_BIN:-${CLAWDBOT_INSTALL_CLI_BIN:-openclaw}}"
...
docker run --rm -t \
  ...
  -e OPENCLAW_INSTALL_CLI_BIN="$INSTALL_CLI_BIN" \
