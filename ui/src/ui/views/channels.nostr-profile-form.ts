  ...
  const renderPicturePreview = () => {
    ...
    return html`
      <div style="margin-bottom: 12px;">
        <img
          src=${picture}
          alt=${t("channels.nostr.picturePreviewAlt")}
  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">${t("channels.nostr.formTitle")}</div>
      ...
      ${renderField("displayName", t("channels.labels.displayName"), {
      ...
      ${renderField("picture", t("channels.nostr.avatarUrl"), {
        ...
        help: t("channels.nostr.avatarUrlHelp"),
      })}
          ...
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              ...
              ${renderField("banner", t("channels.nostr.bannerUrl"), {
                ...
                help: t("channels.nostr.bannerUrlHelp"),
              })}
              ...
              ${renderField("nip05", t("channels.nostr.nip05Identifier"), {
                ...
                help: t("channels.nostr.nip05IdentifierHelp"),
              })}

              ${renderField("lud16", t("channels.nostr.lightningAddress"), {
                placeholder: "you@getalby.com",
                help: t("channels.nostr.lightningAddressHelp"),
              })}
            </div>
          `
          : nothing
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("channels.actions.saving") : t("channels.actions.savePublish")}
        </button>
        ...
        >
          ${state.importing ? t("channels.actions.importing") : t("channels.actions.importFromRelays")}
        </button>
        ...
        >
          ${state.showAdvanced ? t("channels.actions.hideAdvanced") : t("channels.actions.showAdvanced")}
        </button>
