...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "ui/src/ui/views/channel-config-extras.test.ts",
      "ui/src/ui/views/channels.config.test.ts",
      "ui/src/ui/views/channels.regressions.test.ts",
      "ui/src/ui/views/skills.browser.test.ts",
      "ui/src/ui/config-form.browser.test.ts",
      "ui/src/ui/views/config.browser.test.ts",
      "ui/src/ui/views/localization.test.ts",
      "ui/src/ui/app-channels.test.ts",
      "ui/src/ui/chat/slash-command-executor.node.test.ts",
      "ui/src/ui/controllers/agents.test.ts",
      "ui/src/ui/controllers/chat.test.ts",
      "ui/src/ui/controllers/knowledge.test.ts",
