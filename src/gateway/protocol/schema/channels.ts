...
export const ChannelAccountSnapshotSchema = Type.Object(
  {
    ...
    dmScope: Type.Optional(Type.String()),
    sessionScopeSummary: Type.Optional(Type.String()),
    isDefaultAccount: Type.Optional(Type.Boolean()),
    requireMention: Type.Optional(Type.Boolean()),
    allowFrom: Type.Optional(Type.Array(Type.String())),
    groupAllowFrom: Type.Optional(Type.Array(Type.String())),
    clientId: Type.Optional(Type.String()),
    clientSecretConfigured: Type.Optional(Type.Boolean()),
...
export const ChannelUiMetaSchema = Type.Object(
  {
    ...
    selectionLabel: Type.Optional(Type.String()),
